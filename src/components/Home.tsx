        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Pronunciation Practice</h2>
              <p className="text-gray-600 mb-4">Perfect your pronunciation with real-time feedback and guided practice sessions.</p>
